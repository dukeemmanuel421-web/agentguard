...
export type ScanResult = { blocked:boolean; risk:number; sanitized_text:string; detectors:{heuristic:DetectorResult;llm:DetectorResult;probe:DetectorResult};findings:Finding[] }
